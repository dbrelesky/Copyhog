...
**Swipe-to-delete on items, and Hog Wipe button with confirmation alert**
...
1. **Task 1: Add store deletion methods** - `ad8a12e` (feat)
...
- v1.1 milestone complete: item management fully functional
